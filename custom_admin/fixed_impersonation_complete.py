...
HOW TO FIX THE IMPERSONATION FEATURE:

1. Find and delete BOTH instances of the impersonate_user function in views.py
   (around lines 1356 and 1679)

2. Find and delete BOTH instances of the stop_impersonation function in views.py
   (around lines 1378 and 1653)

3. Add these fixed implementations at the end of your views.py file:
"""
